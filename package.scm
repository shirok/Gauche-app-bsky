...
(define-gauche-package "Gauche-app-bsky"
  ...
  ;; summary.
  :description "Bluesky interface library"
  ...
  ;; Homepage URL, if any.
  ; :homepage "http://example.com/Gauche-app-bsky/"

  ;; Repository URL, e.g. github
  :repository "https://github.com/shirok/Gauche-app-bsky.git"
  )
